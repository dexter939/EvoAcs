...
@section('breadcrumb', 'LAN Devices')
@section('page-title', 'LAN Device Management (TR-64)')
    ...
    <div class="col-12">
        <div class="card mb-4">
            <div class="card-header pb-0">
                <h6>LAN Devices (UPnP/SSDP)</h6>
                <p class="text-sm">LAN-Side Device Discovery & Configuration</p>
            </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="align-middle">
                                    <a href="{{ route('acs.lan-devices.detail', $device->id) }}" class="text-secondary font-weight-bold text-xs">
                                        Details
                                    </a>
                                </td>
                            </tr>
