...
@section('breadcrumb', 'STB/IPTV')
@section('page-title', 'Set-Top Box Management (TR-135)')
    ...
    <div class="col-12">
        <div class="card mb-4">
            <div class="card-header pb-0">
                <h6>STB/IPTV Devices</h6>
                <p class="text-sm">Set-Top Box Provisioning, Streaming Protocols, QoS Monitoring</p>
            </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="align-middle">
                                    <a href="{{ route('acs.stb.device', $device->id) }}" class="text-secondary font-weight-bold text-xs">
                                        Configure
                                    </a>
                                </td>
                            </tr>
