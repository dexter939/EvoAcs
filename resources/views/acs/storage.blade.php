...
@section('breadcrumb', 'Storage Services')
@section('page-title', 'NAS/Storage Management (TR-140)')
    ...
    <div class="col-12">
        <div class="card mb-4">
            <div class="card-header pb-0">
                <h6>Storage/NAS Devices</h6>
                <p class="text-sm">Network Attached Storage Configuration & RAID Management</p>
            </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="align-middle">
                                    <a href="{{ route('acs.storage.device', $device->id) }}" class="text-secondary font-weight-bold text-xs">
                                        Manage
                                    </a>
                                </td>
                            </tr>
