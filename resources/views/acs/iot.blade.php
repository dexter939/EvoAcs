...
@section('breadcrumb', 'IoT Devices')
@section('page-title', 'Smart Home Devices (TR-181)')
    ...
    <div class="col-12">
        <div class="card mb-4">
            <div class="card-header pb-0">
                <h6>IoT Smart Home Devices</h6>
                <p class="text-sm">ZigBee, Z-Wave, WiFi, BLE, Matter, Thread Management</p>
            </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="align-middle">
                                    <a href="{{ route('acs.iot.device', $device->id) }}" class="text-secondary font-weight-bold text-xs">
                                        Control
                                    </a>
                                </td>
                            </tr>
