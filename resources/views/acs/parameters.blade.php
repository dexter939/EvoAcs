...
@section('breadcrumb', 'Parameters')
@section('page-title', 'Parameter Discovery (TR-111)')
    ...
    <div class="col-12">
        <div class="card mb-4">
            <div class="card-header pb-0">
                <h6>Device Parameter Discovery</h6>
                <p class="text-sm">TR-111 Device Capability Discovery & Parameter Tree</p>
            </div>
                    ...
                    <table class="table align-items-center mb-0">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Parameters</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="align-middle text-center">
                                    <span class="text-xs">{{ $device->parameters()->count() }}</span>
                                </td>
                                <td class="align-middle text-center">
                                    <span class="text-secondary text-xs">{{ $device->last_contact_time ? $device->last_contact_time->format('d/m/Y H:i') : 'Never' }}</span>
                                </td>
                                <td class="align-middle">
                                    <a href="{{ route('acs.parameters.device', $device->id) }}" class="text-secondary font-weight-bold text-xs">
                                        View
                                    </a>
                                </td>
                            </tr>
